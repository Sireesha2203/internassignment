...
function Table1() {
  ...
  useEffect(()=>{
    const getUsers = async () => {
      try {
        await fetch("http://localhost:3500/user-api/get-users-1")
  ...
  return (
    <div className="text-center container c2 mt-5">
        ...
        <h3 className='header'>Users who have income lower than $5 USD and have a car of brand “BMW” or “Mercedes” </h3>
