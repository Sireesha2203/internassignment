...
open "./Sample_Data_Import_Mongo/import.py" and run it using python. This will automatically import the sample_data from sample_data.json into userCollection of test database in MongoDB
